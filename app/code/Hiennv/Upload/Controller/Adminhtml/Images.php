...
namespace Hiennv\Upload\Controller\Adminhtml;

use Hiennv\Upload\Model\UploaderPool;

abstract class Images extends \Magento\Backend\App\Action
{
    const PARAM_CRUD_ID = 'images_id';
    ...
    public function __construct(
        ...
        \Hiennv\Upload\Model\ImagesFactory $imagesFactory,
